...
from  base.models import User, Staffs, Courses, Subjects, Students, Attendance, AttendanceReport, LeaveReportStudent, FeedBackStudent, StudentResult
...
def student_home(request):
    ...
    #student_home = Students.objects.get(students = request.user.id)
